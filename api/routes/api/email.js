...
emailRouter.get('/unsubscribe', async (req, res) => {
  ...
  try {
    ...
    console.error(err);
    return res.redirect(
      `${rootRedirect}/me/settings?toastType=error&toastMessage=We ran into an issue unsubscribing you from this email. You can always unsubscribe from this email type in your user settings, or get in touch with us at community@vanila.io.`
    );
  }
});
...
emailRouter.get('/validate', (req, res) => {
  ...
  if (communityId) {
    try {
      ...
      console.error(err);
      return res.redirect(
        `${rootRedirect}/me/settings?toastType=error&toastMessage=We ran into an issue validating this email address. You can re-enter your email address in your community settings to resend a confirmation email, or get in touch with us at community@vanila.io.`
      );
    }
  }
  ...
  try {
    ...
    console.error(err);
    return res.redirect(
      `${rootRedirect}/me/settings?toastType=error&toastMessage=We ran into an issue validating this email address. You can re-enter your email address in your user settings to resend a confirmation email, or get in touch with us at community@vanila.io.`
    );
  }
});
