        ...
        attachments: [
          {
            ...
            author_link: `https://${process.env.PROD_DOMAIN}/users/${
              author.username
            }`,
            ...
            title_link: `https://${process.env.PROD_DOMAIN}/thread/${
              incomingThread.id
            }`,
            ...
            actions: [
              {
                ...
                url: `https://${process.env.PROD_DOMAIN}/thread/${
                  incomingThread.id
                }`,
              },
              {
                ...
                url: `https://${process.env.PROD_DOMAIN}/users/${
                  author.username
                }`,
              },
            ],
