    ...
    return (
      <NullCard bg="onboarding" repeat={true} noPadding>
        ...
        <Section>
          ...
          <ButtonRow>
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=https://${process.env.PROD_DOMAIN}&t=Come hang out with me on Spectrum, a new place on the internet for communities!`}
              target="_blank"
            ...
            <a
              href={`https://twitter.com/share?text=Come hang out with me on @withspectrum, a new place on the internet for communities!&url=https://${process.env.PROD_DOMAIN}`}
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button
