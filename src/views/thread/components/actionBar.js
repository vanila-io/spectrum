          ...
          <div style={{ display: 'flex' }}>
              ...
              <ShareButtons>
                ...
                >
                  <a
                    ...
                    )}&u=https://${process.env.PROD_DOMAIN}/${getThreadLink(thread)}`}
                    target="_blank"
                ...
                >
                  <a
                    href={`https://twitter.com/share?url=https://${process.env.PROD_DOMAIN}/${getThreadLink(
                      thread
            ...
            {thread.channel.isPrivate && (
              <ShareButtons>
                <Clipboard
                  style={{ background: 'none' }}
                  data-clipboard-text={`https://${process.env.PROD_DOMAIN}/${getThreadLink(
                    thread
                  )}`}
                  onSuccess={() =>
                    this.props.dispatch(
